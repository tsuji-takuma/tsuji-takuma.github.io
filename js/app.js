...
(() => {
  ...
  const en = {
    ...
    intro: "My research focuses on extracting expressions of causal relationships from financial documents using natural language processing. This work is conducted in collaboration with Preferred Networks.",
